...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x46, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x55, 0x73,
	...
	0x73, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x67, 0x65, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x55,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x19, 0x5a, 0x17, 0x74, 0x63,
	0x70, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x73, 0x72, 0x63, 0x2f, 0x61, 0x70, 0x69, 0x2f,
...
var file_proto_user_proto_goTypes = []interface{}{
	...
	(*UserInfoReply)(nil),     // 3: api.UserInfoReply
	(*UserInfo)(nil),          // 4: api.UserInfo
}
var file_proto_user_proto_depIdxs = []int32{
	4, // 0: api.UserInfoReply.userInfo:type_name -> api.UserInfo
	0, // 1: api.User.Login:input_type -> api.LoginRequest
	1, // 2: api.User.GetUser:input_type -> api.getUserRequest
	2, // 3: api.User.UpdateUser:input_type -> api.UpdateUserRequest
	3, // 4: api.User.Login:output_type -> api.UserInfoReply
	3, // 5: api.User.GetUser:output_type -> api.UserInfoReply
	3, // 6: api.User.UpdateUser:output_type -> api.UserInfoReply
